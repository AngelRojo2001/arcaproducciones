...
<div class="container marketing">
    ...
    <div class="row text-center">
        <div class="col-lg-4">
            <img class="img-circle" src="public/storage/perfil.jpg" height="140" width="140">
        ...
        <div class="col-lg-4">
            <img class="img-circle" src="public/storage/teclado1.jpg" alt="Generic placeholder image" height="140" width="140">
            <h2>Provervios 17:17</h2>
            <p>En todo Tiempo ama al amigo y es como un hermano en tiempos de angustia</p>
            <p><a class="btn btn-default" href="#" role="button">View details »</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle" src="public/storage/teclado2.jpg" alt="Generic placeholder image" height="140" width="140">
            <h2>Juan 3:16</h2>
    ...
    <div class="row featurette">
        ...
        <div class="col-md-7 <?= ($sw != 0)?'col-md-pull-5':'' ?>">
            <img data-holder-rendered="true" src="public/storage/<?= $publicacion->imagen; ?>" class="featurette-image img-responsive center-block image-crecer" alt="500x500">
        </div>
    </div>
    <?php
    if ($sw == 0) {
